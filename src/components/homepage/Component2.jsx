    ...
    return (
        <div className="section-2 lg:px-24 px-4 mt-10 pb-18">
            ...
            <div className="section2-top flex flex-wrap items-center justify-between">
                <p className="heading">5 Simple Steps to e-file your <span className="text-green-700">Income Tax Return</span></p>
                <div className="btn-div flex bg-green-700 inline-flex px-12 py-2  gap-3 rounded-full">
                    <p className="eCA text-white">File Now</p>
                    <img src="https://tax2win.in/assets-new/img/new-theme/w-ghost-arrow.svg" alt="ITR Now" title="File Now" />
                </div>
            </div>
         {/* small sections */}                    
