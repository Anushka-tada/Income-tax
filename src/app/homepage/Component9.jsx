  ...
  return (
    <div className="section9 lg:px-24 px-4 text-center py-10">
     ...
     <div className="section9-parts flex lg:flex-nowrap flex-wrap gap-6">
        ...
        <img src="https://tax2win.in/assets-new/img/new-theme/g_ghost_arrow.svg " alt="Income Tax Notice Assistance" title="Income Tax Notice Assistance" loading="lazy" width="22" height="22" className="icon"></img>
