...
//                                    <div className="deemed-inputs  flex  flex-wrap justify-start mt-3 gap-5 ">
//                                    <div className="yes-input flex flex-col items-start">
//                                         <label htmlFor="interest-on-loan" >Name of Tenant*</label>
//                                         <input id="interest-on-loan" type="text" className="p-3 rounded-lg mt-3" />
//                                     </div>

//                                     <div className="yes-input flex flex-col items-start">
//                                         <label htmlFor="interest-on-loan" >PAN of Tenant (optional)</label>
//                                         <input id="interest-on-loan" type="text" className="p-3 rounded-lg mt-3" />
//                                     </div>

//                                     <div className="yes-input flex flex-col items-start">
//                                         <label htmlFor="interest-on-loan">Rent Received *</label>
//                                         <input id="interest-on-loan" type="text" className="p-3 rounded-lg mt-3" />
//                                     </div>
//                                    </div>
//                                 </div>
...
//                     {showYesContent && (
//                         <div className="yes-content flex flex-wrap justify-center mt-6 gap-5">
//                             <div className="yes-input flex flex-col">
